function save_file = stfeatures_long_video(video_filename, output_path, start_frame, end_frame, overlap)
...
frame1 = double(max(0, start_frame - overlap));
frame2 = double(max(clip_length, end_frame + overlap));
