...
% mod by JCN, since I run this on multiple machines, I need to get the
% right parameters for the current machine
global Params

%if ~isstruct(Params)
%    if ~isfield(Params,'K_conv2')
%        fprintf('\n');
%        disp('first convolution, setting up parameters, this takes a little long...')
%        setupTimeConv;
%    end
%end
